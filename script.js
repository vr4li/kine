...
const translations = {
  ar: {
    ...
    cameraTag: "جلسة تأهيل",
    cameraTitle: "اذكر تشخيصك — اختر تمرين — تشغيل الكاميرا",
    cameraDesc: "ثلاث خطوات: اذكر تشخيصك، اختر تمريناً، ثم شغّل الكاميرا — النظام يحلّل وضعيتك ويصحّحك.",
    conditionLabel: "اذكر تشخيصك",
    conditionPlaceholder: "مثال: انزلاق غضروفي، ألم ركبة...",
    conditionSearch: "ابحث",
    therapyStep1: "① اذكر تشخيصك",
    therapyStep2: "② اختر تمرين",
    therapyStep3: "③ تشغيل الكاميرا",
    cameraLaunch: "تشغيل الكاميرا",
    cameraIdleText: "تشغيل الكاميرا",
  ...
  en: {
    ...
    cameraTag: "Try Now",
    cameraTitle: "Diagnosis — Exercise — Camera",
    cameraDesc: "Three steps: enter diagnosis, choose exercise, start camera — we analyze and correct your form.",
    cameraIdleText: "Start camera",
    conditionLabel: "Enter your diagnosis",
    conditionPlaceholder: "e.g. disc herniation, knee pain...",
    conditionSearch: "Search",
    therapyStep1: "① Enter diagnosis",
    therapyStep2: "② Choose exercise",
    therapyStep3: "③ Start camera",
